...
using frEnvironment = CommonElement.ChainEnvironment;
...
namespace FlowRunner.Engine.Tests
{
    ...
    public class ChainEnvironmentTests
    {
        ...
        public void GetValueTest4_2() {
            ...
            frEnvironment environment = new frEnvironment();
            MultiBandUpstairEnvironment multiBand1 = new MultiBandUpstairEnvironment(environment);
            frEnvironment environment2 = new frEnvironment();
            MultiBandUpstairEnvironment multiBand2 = new MultiBandUpstairEnvironment(environment2);
            multiBand1.UpstairEnvironments.Add(environment2);
            multiBand2.UpstairEnvironments.Add(upstairEnvironment);
